...
TEMPLATES: Dict[str, Dict[str, object]] = {
    ...
    "void": {
        ...
        "aspect": "3:4",
        "ban": (
            "负空间是结构。一个主手势：开口、枝干或屋脊切开色场。"
            "开口里才是建筑或山水，小人只作尺度。矿物色，不要堆人。"
            "不要赛博，不要明信片写实。"
        ),
    },
    "habitat": {
        ...
        "ban": (
            "一块能住人的地形：坡面相连，水走低处。"
            "一条人居路线，一种有原因的天气，一个尺度锚。"
            "不要散落小屋，不要旅行册，不要过饱和明信片。"
        ),
    },
    "photo": {
        "label": "实写分层",
        ...
        "aspect": "3:4",
        "ban": (
            "字段写，不要散文：主体、表情、服装结构、光、机位、质感、负向锁定。"
            "衣服写肩带、接缝、褶皱，不要只写颜色。写清机位高度和谁被画面切断。"
            "负向锁住点名的姿态和主角道具。一人一场景。不要泳装，不要插画，不要磨皮。"
        ),
    },
    "beads": {
        "label": "拼豆",
